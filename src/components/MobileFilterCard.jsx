...
//         className="fixed top-0 pl-1 md:hidden right-0 h-full w-64 bg-black  border-x-0 border-b-0  shadow-md shadow-white z-50"
//       >
//         {/* <div className="p-4 w-full m-auto justify-center h-full flex flex-col rounded-l-md"> */}
...
//           </div>
//           <ul className="mt-4">
//             <h1 className="font-medium text-lg text-white">Location</h1>
...
//               })}
//             </div>
//             <h1 className="font-medium text-lg text-white">Industry</h1>
//             <div className="overflow-y-auto max-h-[220px] mb-4">
...
//               <h1 className="font-medium text-lg text-white">Salary</h1>
...
//               })}
//             </div>
//             <div className="flex w-full m-auto space-x-5 pr-2">
