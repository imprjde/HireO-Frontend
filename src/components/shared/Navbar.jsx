...
//   return (
//     <div className=" text-white bg-black pr-4 md:pr-0  md:px-4 md:pt-1 ">
//       <AnimatePresence>
//         {showModal && (
//           <LogoutConfirmation
//             showModal={showModal}
...
//           <img
//             src={logo}
//             className="w-[150px] md:w-[170px] mt-2 md:mt-3"
//             alt="logo"
//           />
//         </Link>
...
const Navbar = () => {
  ...
  return (
    <div className=" text-white bg-black sticky top-0 z-40 pr-4 md:pr-0  md:px-4 md:pt-1 ">
      <AnimatePresence>
        {showModal && (
          <LogoutConfirmation
            showModal={showModal}
